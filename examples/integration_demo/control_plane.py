...
_RUNTIME_EXPORT_NETWORK_KPI_DYNAMIC_STATUS_FILENAME = (
...
class DemoControlPlane:
    ...
    def export_runtime_package(
        ...
        *,
        ...
        network_kpi_dynamic_status_path = (
            package_dir / _RUNTIME_EXPORT_NETWORK_KPI_DYNAMIC_STATUS_FILENAME
        )
        ...
        network_kpi_dynamic_status_path.write_text(
            stable_json_pretty(network_kpi_dynamic_status),
            encoding="utf-8",
        )
        written_files["network_kpi_dynamic_status_v1"] = (
            network_kpi_dynamic_status_path
        )
        ...
        network_flow_lifecycle_summary_path.write_text(
            stable_json_pretty(network_flow_lifecycle_summary),
            encoding="utf-8",
        )
        ...
        node_network_pressure_summary_path = (
            package_dir / _RUNTIME_EXPORT_NODE_NETWORK_PRESSURE_SUMMARY_FILENAME
        )
        ...
        node_network_pressure_summary_path.write_text(
            stable_json_pretty(node_network_pressure_summary),
            encoding="utf-8",
        )
