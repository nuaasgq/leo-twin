...
def build_full_system_task_specs() -> tuple[FullSystemTaskSpec, ...]:
    ...
    return (
        ...
        FullSystemTaskSpec(
            task_id="FS-065",
            title_zh="双前端按需加载与三维数据屏解耦",
            module=TaskModule.FRONTEND,
            dependencies=("FS-050", "FS-060"),
            priority=84,
            event_load=10,
            memory_mb=10,
            latency_ms=5,
        ...
        FullSystemTaskSpec(
            task_id="FS-095",
            title_zh="算力负载反馈网络重路由闭环",
            module=TaskModule.NETWORK,
            dependencies=("FS-080", "FS-090"),
            priority=80,
            event_load=24,
            memory_mb=10,
            latency_ms=6,
        ...
        FullSystemTaskSpec(
            task_id="FS-097",
            title_zh="应用层与数据链路层流级运行时",
            module=TaskModule.NETWORK,
            dependencies=("FS-030", "FS-080"),
            priority=80,
            event_load=18,
            memory_mb=8,
            latency_ms=5,
        ...
        FullSystemTaskSpec(
            task_id="FS-098",
            title_zh="数据面板协议信道算力KPI补强",
            module=TaskModule.FRONTEND,
            dependencies=("FS-060", "FS-070"),
            priority=80,
            event_load=12,
            memory_mb=12,
            latency_ms=5,
        ...
        FullSystemTaskSpec(
            ...
            title_zh="完整版全链路集成验证",
            module=TaskModule.SYSTEM,
            dependencies=("FS-065", "FS-095", "FS-096", "FS-097", "FS-098"),
            priority=80,
            event_load=40,
            memory_mb=20,
            latency_ms=10,
